...
| `ats-mini-original` | ATS Mini Original | [`esp32-si4732/ats-mini` `v2.39`](https://github.com/esp32-si4732/ats-mini/releases/tag/v2.39) — merged image re-hosted as [this repo `ats-mini-original-v2.39`](https://github.com/wendells01/ats-mini-hub/releases/tag/ats-mini-original-v2.39) (upstream ships only split zips; `v2.38` release retained as rollback) | 8388608 | 1698544 | littlefs 0x83, 0x70000 |
...
- Tag `marauder-firmware`, asset `Marauder-Firmware`
  (8388608 B).
- Tag `ats-mini-original-v2.39`, asset `ats-mini-original-v2.39-merged.bin`
...
- Tag `ats-mini-original-v2.38`, asset `ats-mini-original-v2.38-merged.bin`
  (8388608 B) — retained as rollback; superseded by v2.39.
